export async function onRequestGet(context) {
  ...
  try {
    ...
    const html = buildBrandedEmail({
      ...
      body: lang === 'en'
        ? 'Your email has been confirmed successfully. You can now access your Kuzamo dashboard and get started.'
        : 'E‑posta adresiniz başarıyla doğrulandı. Artık Kuzamo paneline erişerek başlayabilirsiniz.',
      ctaText: lang === 'en' ? 'Open Dashboard' : 'Paneli Aç',
      ctaUrl: (env.BASE_URL || new URL('/', request.url).origin) + '/index.html',
      footer: lang === 'en' ? 'If this wasn’t you, you can ignore this email.' : 'Bu işlem size ait değilse e‑postayı yok sayabilirsiniz.'
    });
